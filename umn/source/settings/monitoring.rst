:original_name: cce_10_0836.html
...
**Send stdout Logs to AOM 1.0** (**No more evolution**): Logging in AOM 1.0 will not be improved, so you are advised to disable this function and use LTS logging instead.
