...
-  :ref:`Service Priority-based Scheduling <cce_10_0785__section61971703016>`
-  :ref:`Resource Utilization-optimized Scheduling (Supported by Volcano Scheduler) <cce_10_0785__section15912157011>`
-  :ref:`Enhanced AI Job Scheduling (Supported by Volcano Scheduler) <cce_10_0785__section56816252018>`
-  :ref:`Heterogeneous Resource Scheduling (Supported by Volcano Scheduler) <cce_10_0785__section1697213291411>`
...
Resource Utilization-optimized Scheduling (Supported by Volcano Scheduler)
--------------------------------------------------------------------------
...
.. table:: **Table 2** Bin packing weight
   ...
   +==================================+============================================================================================================================================================+===============+
   | Binpack Policy Weight            | A larger value indicates a higher weight of the bin packing policy in overall scheduling.                                                                  | 10            |
   +----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+
   ...
   +----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+
   | Custom Resource Requested by Pod | Other custom resource types requested by pods, for example, **nvidia.com/gpu**. A larger value indicates a higher usage of the specified cluster resource. | None          |
   +----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+
...
Enhanced AI Job Scheduling (Supported by Volcano Scheduler)
-----------------------------------------------------------
...
Heterogeneous Resource Scheduling (Supported by Volcano Scheduler)
------------------------------------------------------------------
