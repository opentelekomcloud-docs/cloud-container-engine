...
By default, CCE automatically calculates the reserved memory based on the rules listed in :ref:`Table 3 <cce_10_0178__table1061012595214>`. You can customize the reserved memory by configuring parameters **system-reserved-mem** and **kube-reserved-mem** in the node pool settings. For details, see :ref:`Modifying Node Pool Configurations <cce_10_0652>`.
