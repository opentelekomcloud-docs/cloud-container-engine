...
-  **Rootfs (Device Mapper)**
   ...
   -  The **/var/lib/docker** directory is used as the Docker working directory and occupies 20% of the container engine and container image space by default. (Space of the **/var/lib/docker** directory = **Data disk space x 90% x 20%**)
   ...
   .. figure:: /_static/images/en-us_image_0000002483959392.png
...
-  **Rootfs (OverlayFS)**
   ...
   .. figure:: /_static/images/en-us_image_0000002516199341.png
...
The custom pod container space (basesize) is related to the node OS and container storage Rootfs. For details about the container storage Rootfs, see :ref:`Mapping Between OS and Container Storage Rootfs <cce_10_0341__section1473612279214>`.
