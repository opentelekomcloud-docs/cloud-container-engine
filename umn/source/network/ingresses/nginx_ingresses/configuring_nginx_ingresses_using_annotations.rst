...
.. table:: **Table 1** Ingress type annotations
   ...
   |                             |                 |                                                                                                                                                         |                                   |
   |                             |                 | For clusters of v1.23 or later, use the parameter **ingressClassName**. For details, see :ref:`Using kubectl to Create an Nginx Ingress <cce_10_0364>`. |                                   |
   +-----------------------------+-----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------+

For details about how to use the preceding annotations, see :ref:`Using kubectl to Create an Nginx Ingress <cce_10_0364>`.
