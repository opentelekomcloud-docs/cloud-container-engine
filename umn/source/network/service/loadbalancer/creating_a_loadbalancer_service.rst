...
.. figure:: /_static/images/en-us_image_0000001750791112.png
...
.. figure:: /_static/images/en-us_image_0000001797870801.png
...
#. Create the files named **nginx-deployment.yaml** and **nginx-elb-svc.yaml** and edit them.
   ...
   **vi nginx-elb-svc.yaml**
   ...
   For more annotations and examples related to advanced functions, see :ref:`Using Annotations to Configure Load Balancing <cce_10_0385>`.
   ...
   .. table:: **Table 3** elb.session-affinity-option data structure
   ...
   .. table:: **Table 4** elb.health-check-option data structure
...
#. Enter the URL in the address box of the browser, for example, **10.78.42.242:80**. **10.78.42.242** indicates the IP address of the load balancer, and **80** indicates the access port displayed on the CCE console.
   ...
   .. figure:: /_static/images/en-us_image_0000001750950032.png
...
#. Create the files named **nginx-deployment.yaml** and **nginx-elb-svc.yaml** and edit them.
   ...
   **vi nginx-elb-svc.yaml**
   ...
   .. table:: **Table 6** elb.autocreate data structure
...
#. Enter the URL in the address box of the browser, for example, **10.78.42.242:80**. **10.78.42.242** indicates the IP address of the load balancer, and **80** indicates the access port displayed on the CCE console.
   ...
   .. figure:: /_static/images/en-us_image_0000001797870805.png
