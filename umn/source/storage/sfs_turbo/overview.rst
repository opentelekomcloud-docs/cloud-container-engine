...
-  :ref:`Dynamically Creating and Mounting Subdirectories of an SFS Turbo File System <cce_bestpractice_00253>`: SFS Turbo allows you to dynamically create subdirectories and mount them to containers so that SFS Turbo can be shared and the SFS Turbo storage capacity can be used more economically and properly.
