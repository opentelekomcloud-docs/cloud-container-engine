...
#. Statically create a PVC and PV.
   ...
   a. Choose **Storage** in the navigation pane. In the right pane, click the **PVCs** tab. Click **Create PVC** in the upper right corner. In the dialog box displayed, configure PVC parameters.
      ...
      +---------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | Subdirectory\ :sup:`b`                | Determine whether to use subdirectories to create PVs. If this parameter is set to **Yes**, enter the absolute path of the subdirectory, for example, **/a/b**.                                                                                                                                                                         |
      +---------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      ...
      +---------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | Reclaim Policy\ :sup:`b`              | Only **Retain** is available if you do not use subdirectories to create PVs. This indicates that the PV will not be deleted when the PVC is deleted. For details, see :ref:`PV Reclaim Policy <cce_10_0378__section19999142414413>`. If you choose to use a subdirectory to create a PV, the value of this parameter can be **Delete**. |
      +---------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
#. Create an application.
   ...
   b. Click **Create Workload** in the upper right corner. On the displayed page, click **Data Storage** in the **Container Information** area under **Container Settings** and choose **Add Volume** > **PVC**.
      ...
      Mount and use storage volumes. For details about the parameters, see :ref:`Table 1 <cce_10_0625__table2529244345>`. For other parameters, see :ref:`Workloads <cce_10_0046>`.
   ...
   a. .. _cce_10_0625__li186261858193110:
      ...
      .. code-block::
         ...
         metadata:
           annotations:
             pv.kubernetes.io/provisioned-by: everest-csi-provisioner
             everest.io/reclaim-policy: retain-volume-only    # (Optional) When a PVC is deleted, the PV will be deleted, but the subdirectories associated with the PV will be retained. This parameter is available only when subdirectories are used and the reclaim policy is Delete.
           name: pv-sfsturbo    # PV name
         spec:
           accessModes:
           - ReadWriteMany      # Access mode. The value must be ReadWriteMany for SFS Turbo.
      ...
      .. table:: **Table 4** Key parameters
         ...
         | Parameter                        | Mandatory             | Description                                                                                                                                                                                                                                                                                         |
         +==================================+=======================+=====================================================================================================================================================================================================================================================================================================+
         | everest.io/reclaim-policy        | No                    | Whether to retain subdirectories when deleting a PVC. This parameter must be used with :ref:`PV Reclaim Policy <cce_10_0378__section19999142414413>`. This parameter is available only when the PV reclaim policy is **Delete**.                                                                    |
         |                                  |                       |                                                                                                                                                                                                                                                                                                     |
         ...
         +----------------------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
         | everest.io/volume-as             | Yes                   | The value is fixed at **absolute-path**, indicating that the current PV associates with a subdirectory of the SFS Turbo file system.                                                                                                                                                                |
         |                                  |                       |                                                                                                                                                                                                                                                                                                     |
         |                                  |                       | Ensure Everest v2.3.23 or later has been installed in the cluster.                                                                                                                                                                                                                                  |
         +----------------------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
         | everest.io/share-export-location | Yes                   | Shared path of the SFS Turbo file system subdirectory. The value consists of the shared path of the SFS Turbo file system and the absolute path of the subdirectory. Customize the absolute path of the subdirectory, for example, **/a/b**. Ensure that the subdirectory exists and is accessible. |
         |                                  |                       |                                                                                                                                                                                                                                                                                                     |
         |                                  |                       | Format:                                                                                                                                                                                                                                                                                             |
         |                                  |                       |                                                                                                                                                                                                                                                                                                     |
         |                                  |                       | .. code-block::                                                                                                                                                                                                                                                                                     |
         ...
         +----------------------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
         | everest.io/sfsturbo-share-id     | Yes                   | ID of an SFS Turbo file system.                                                                                                                                                                                                                                                                     |
         |                                  |                       |                                                                                                                                                                                                                                                                                                     |
         ...
         +----------------------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
         | storageClassName                 | Yes                   | The StorageClass of SFS Turbo is **csi-sfsturbo**.                                                                                                                                                                                                                                                  |
         +----------------------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
         | mountOptions                     | No                    | Mount options.                                                                                                                                                                                                                                                                                      |
         |                                  |                       |                                                                                                                                                                                                                                                                                                     |
         |                                  |                       | If not specified, the following configurations are used by default. For details, see :ref:`Configuring SFS Turbo Mount Options <cce_10_0626>`.                                                                                                                                                      |
...
.. table:: **Table 6** Related operations
   ...
   |                                                                                  |                                                                                                                                            |                                                                                                                                                                                                                                                                                           |
   |                                                                                  |                                                                                                                                            |    -  **Reclaim Policy**: Only **Retain** is available if you do not use subdirectories to create PVs. For details, see :ref:`PV Reclaim Policy <cce_10_0378__section19999142414413>`. If you choose to use a subdirectory to create a PV, the value of this parameter can be **Delete**. |
   |                                                                                  |                                                                                                                                            |                                                                                                                                                                                                                                                                                           |
   ...
   +----------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Editing Reclaim Policy (supported only for PVs created using subdirectories)     | Modify the reclaim policy of a PV.                                                                                                         | #. In the navigation pane, choose **Storage**. Then click the **PVs** tab.                                                                                                                                                                                                                |
   |                                                                                  |                                                                                                                                            | #. Locate the row containing the target PV and choose **More** > **Edit Reclaim Policy**.                                                                                                                                                                                                 |
   +----------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Synchronizing capacity (supported only for PVCs created from non-subdirectories) | When the underlying storage outgrows the PVC, resize the PVC capacity on the CCE console to match the new size.                            | #. In the navigation pane, choose **Storage**. Then, click the **PVCs** tab.                                                                                                                                                                                                              |
   |                                                                                  |                                                                                                                                            |                                                                                                                                                                                                                                                                                           |
