...
#. In the navigation pane, choose **Policies**. On the **Scaling Policies** tab, click the **HPA Policies**/**CronHPA Policies** tab based on the scaling policy type.
#. Check the latest status, rules, and associated workloads of a scaling policy.
   ...
   .. note::
      ...
      c. On the workload details page, switch to the **Auto Scaling** tab to obtain the scaling policies. You can also obtain the scaling policies you configured on the **Policies** page.
