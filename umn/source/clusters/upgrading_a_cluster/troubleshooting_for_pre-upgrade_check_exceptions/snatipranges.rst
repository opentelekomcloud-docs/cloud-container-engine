...
When you update **SNATIPRanges** in a region's backbone configuration, the change will be applied after the cluster is upgraded. However, the pod's route table will not be automatically updated. To fix this, simply restart the pod to refresh its route table.
...
.. |image1| image:: /_static/images/en-us_image_0000002516199209.png
