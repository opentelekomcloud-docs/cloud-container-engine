...
.. table:: **Table 1** Cluster configuration and resource management features
   ...
   +--------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Enabling Overload Control for a Cluster <cce_10_0602>` | Overload control dynamically limits concurrent external requests based on the resource pressure of the master node, ensuring the stability and reliability of both the master nodes and the cluster.                                                                                                                                               |
   |                                                              |                                                                                                                                                                                                                                                                                                                                                    |
