...
.. figure:: /_static/images/en-us_image_0166039537.png
...
.. table:: **Table 1** Comparison between the two deployment modes
   ...
   |                                 |                                                                                                                                                                                |                                                                                                                                                                         |
   |                                 | During version upgrades, you need to log in to VMs one by one and manually configure the upgrades, which is inefficient and error-prone.                                       | Version upgrades can be completed within seconds by replacing the image tag. In addition, CCE provides rolling updates, ensuring zero service downtime during upgrades. |
   +---------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
