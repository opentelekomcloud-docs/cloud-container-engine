...
.. table:: **Table 1** Sticky session types
   ...
   +=================+====================================+=====================================================================================================================================================================================================================================================================+===================================================================================================+
   | Layer 4         | TCP- or UDP-compliant Services     | **Source IP address**: The source IP address of each request is used as the hash key to map the needed server from the static hash table. This means that all access requests from the same IP address will be forwarded to the same backend server for processing. | -  Source IP addresses of the clients have changed.                                               |
