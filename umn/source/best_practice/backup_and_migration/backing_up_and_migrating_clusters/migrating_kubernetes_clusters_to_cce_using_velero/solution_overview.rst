...
Now you can address the preceding challenges by using CCE, a service that allows easy cluster management and flexible scaling, integrated with Helm charts to simplify cluster O&M and reduce operations costs. CCE is easy to use and delivers high performance, security, reliability, openness, and compatibility. This section describes the solution and procedure for migrating on-premises clusters to CCE.
...
.. table:: **Table 1** Resources that can be migrated
   ...
   +-----------------------------+----------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |                             | PersistentVolumes (PVs) mounted to containers                                          | Due to restrictions of the restic tool, migration is not supported for the hostPath storage volume. For details about how to solve the problem, see :ref:`hostPath Volumes Cannot Be Backed Up <cce_bestpractice_0314__section11197194820367>`.                                                                                                |
   +-----------------------------+----------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. figure:: /_static/images/en-us_image_0000002484118198.png
...
.. |image1| image:: /_static/images/en-us_image_0000002516078173.png
