...
According to :ref:`Migration Solution <cce_bestpractice_0307__section96147345128>`, you will need to prepare temporary object storage to store backup files before the migration. Velero supports OBS as the object storage. For details about how to deploy Velero, see :ref:`Installing Velero <cce_bestpractice_0310__section138392220432>`.
...
-  If you are using OBS to store backup files, you must obtain the AK/SK of a user who can operate OBS. For details, see `Obtaining Access Keys (AK/SK) <https://docs.otc.t-systems.com/en-us/api/obs/obs_04_0116.html>`__.
...
#. Download the binary file of `Velero 1.15.1 <https://github.com/vmware-tanzu/velero/releases/download/v1.15.1/velero-v1.15.1-linux-amd64.tar.gz>`__.
...
#. .. _cce_bestpractice_0310__li1722825643415:
   ...
   Deploy the Velero server. Change the value of **--bucket** to the name of the created object storage bucket. In this example, the bucket name is **velero**. For more details about custom installation parameters, see `Customize Velero Install <https://velero.io/docs/v1.15/customize-installation/>`__.
   ...
   .. table:: **Table 1** Installation parameters of Velero
      ...
      +-----------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------+
      | --plugins                         | Container image address of the component.                                                                                                             |
      +-----------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------+
      ...
      +-----------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------+
      | --backup-location-config          | OBS bucket configuration.                                                                                                                             |
      |                                   |                                                                                                                                                       |
