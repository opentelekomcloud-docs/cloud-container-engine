...
#. Create a YAML file named **ingress-test.yaml**. The file name can be customized.
   ...
   **Example of a dedicated load balancer (public network access) for clusters of v1.21 or earlier:**
   ...
   .. table:: **Table 1** Key parameters
      ...
      |                                           |                                         |                       |                                                                                                                                                                                                                                                                                                                                         |
      |                                           | (only for clusters of v1.21 or earlier) |                       | This parameter is mandatory when you create an ingress.                                                                                                                                                                                                                                                                                 |
      +-------------------------------------------+-----------------------------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | ingressClassName                          | Yes                                     | String                | **cce**: A proprietary LoadBalancer ingress is used.                                                                                                                                                                                                                                                                                    |
      |                                           |                                         |                       |                                                                                                                                                                                                                                                                                                                                         |
      |                                           | (only for clusters of v1.23 or later)   |                       | This parameter is mandatory when you create an ingress.                                                                                                                                                                                                                                                                                 |
      +-------------------------------------------+-----------------------------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
#. Create a YAML file named **ingress-test.yaml**. The file name can be customized.
   ...
   **If the cluster version is 1.21 or earlier, the YAML file configuration is as follows:**
   ...
   .. table:: **Table 3** Key parameters
      ...
      +-------------------------+-----------------+-----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | kubernetes.io/elb.ip    | No              | String          | IP address of a load balancer.                                                                                                                                                                          |
      |                         |                 |                 |                                                                                                                                                                                                         |
...
.. |image1| image:: /_static/images/en-us_image_0000002434240844.png
