...
.. figure:: /_static/images/en-us_image_0000002434079816.png
...
.. figure:: /_static/images/en-us_image_0000002467718301.png
...
-  Constraints on the service affinity (:ref:`externalTrafficPolicy <cce_10_0249__section18134208069>`) configuration of a Service:
   ...
   -  If the service affinity is set to the node level (:ref:`externalTrafficPolicy <cce_10_0249__section18134208069>` is set to **Local**), access to the load balancer from within the cluster may be abnormal. For details, see :ref:`Why a Service Fail to Be Accessed from Within the Cluster <cce_10_0249__section52631714117>`.
...
#. Configure parameters.
   ...
   -  **Annotation**: The LoadBalancer Service has some advanced CCE functions, which are implemented by annotations. For details, see :ref:`Configuring Advanced Load Balancing Functions Using Annotations <cce_10_0385>`.
...
#. Enter the URL in the address box of the browser, for example, **10.78.42.242:80**. **10.78.42.242** indicates the IP address of the load balancer, and **80** indicates the access port displayed on the CCE console.
   ...
   .. figure:: /_static/images/en-us_image_0000002467678137.png
