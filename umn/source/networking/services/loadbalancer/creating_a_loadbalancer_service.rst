...
.. figure:: /_static/images/en-us_image_0000002483959016.png
   :alt: **Figure 1** LoadBalancer Service
...
.. figure:: /_static/images/en-us_image_0000002483959018.png
   :alt: **Figure 2** ELB passthrough networking
...
-  Constraints on dedicated load balancers:
   ...
   -  Dedicated load balancers must operate in private networks using private IP addresses.
   -  For HTTP/HTTPS, dedicated load balancers must support the protocol and clusters must meet version requirements. For details, see :ref:`Configuring HTTP/HTTPS for a LoadBalancer Service <cce_10_0683>`.

-  Constraints on the service affinity (:ref:`externalTrafficPolicy <cce_10_0249__section18134208069>`) configuration of a Service:

   -  If the service affinity is set to the node level (:ref:`externalTrafficPolicy <cce_10_0249__section18134208069>` is set to **Local**), access to the load balancer from within the cluster may be abnormal. For details, see :ref:`Why a Service Fails to Be Accessed from Within the Cluster <cce_10_0249__section52631714117>`.
...
#. Configure parameters.
   ...
   -  **Service Affinity**: For details, see :ref:`Service Affinity (externalTrafficPolicy) <cce_10_0249__section18134208069>`.
   ...
   -  **Load Balancer**: Select a load balancer type and creation mode.
      ...
      .. table:: **Table 1** Load balancer configuration
   ...
   -  .. _cce_10_0681__li15274642132013:
      ...
      **Health Check**: Configure health check for the load balancer.
      ...
      -  **Custom**: applies to :ref:`ports <cce_10_0681__li388800117144>` using different protocols. For details about the YAML configuration for custom health check, see :ref:`Configuring Health Check on Multiple LoadBalancer Service Ports <cce_10_0684>`.
   ...
   -  .. _cce_10_0681__li388800117144:
      ...
      **Port**
      ...
      -  **Health Check**: If :ref:`Health Check <cce_10_0681__li15274642132013>` is set to **Custom**, you can configure health check for ports using different protocols. For details, see :ref:`Table 2 <cce_10_0681__table11219123154614>`.
   ...
   -  **Listener**
      ...
      -  **SSL Authentication**: Select this option if **Frontend Protocol** is set to **HTTPS** or **TLS**. Dedicated load balancers are available in clusters of v1.23.14-r0, v1.25.9-r0, v1.27.6-r0, v1.28.4-r0, or later.
      ...
      -  **Security Policy**: If **Frontend Protocol** is set to **HTTPS** or **TLS**, you can select a security policy. This parameter is available only in clusters of v1.23.14-r0, v1.25.9-r0, v1.27.6-r0, v1.28.4-r0, or later.

      -  **Backend Protocol**: If **Frontend Protocol** is set to **HTTPS**, HTTP or HTTPS can be used to access the backend server. The default value is **HTTP**. If **Frontend Protocol** is set to **TLS**, TCP or TLS can be used to access the backend server. The default value is **TCP**. This parameter is available only in clusters of v1.23.14-r0, v1.25.9-r0, v1.27.6-r0, v1.28.4-r0, or later.
      ...
      -  **Advanced Options**
         ...
         +-----------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------+
         | Response Timeout (s)  | The duration within which a response from the backend server is expected. If the backend server does not respond within this period after receiving a request, the load balancer will stop waiting and return an HTTP 504 error.                                                            | This parameter is available only when **Frontend Protocol** is set to **HTTP** or **HTTPS**. |
         +-----------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------+
         | Enable HTTP/2         | Whether to enable HTTP/2 for HTTPS requests between the client and the load balancer. Request forwarding using HTTP/2 improves access performance between your application and the load balancer. However, the load balancer still uses HTTP/1.x to forward requests to the backend server. | This parameter is available only when **Frontend Protocol** is set to **HTTPS**.             |
         +-----------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------+

   -  **Annotation**: LoadBalancer Services expose advanced CCE functions via annotations. For details, see :ref:`Configuring Advanced Load Balancing Functions Using Annotations <cce_10_0385>`.
...
#. Create and edit the **nginx-elb-svc.yaml** file to configure Service parameters. **nginx-elb-svc.yaml** is an example file name. You can rename it as needed.
   ...
   For more annotations and examples related to advanced functions, see :ref:`Configuring Advanced Load Balancing Functions Using Annotations <cce_10_0385>`.
   ...
   .. table:: **Table 3** annotations parameters
      ...
      |                                           |                 |                                                          |                                                                                                                                                                                                                                                                                                        |
      |                                           |                 |                                                          | This parameter is mandatory when you associate an existing load balancer. **The value cannot be changed after the Service is created.**                                                                                                                                                                |
      |                                           |                 |                                                          |                                                                                                                                                                                                                                                                                                        |
      |                                           |                 |                                                          | **How to obtain**:                                                                                                                                                                                                                                                                                     |
      |                                           |                 |                                                          |                                                                                                                                                                                                                                                                                                        |
      |                                           |                 |                                                          | On the management console, click **Service List**, and choose **Networking** > **Elastic Load Balance**. Click the name of the target load balancer. On the **Summary** tab, find and copy the ID.                                                                                                     |
      |                                           |                 |                                                          |                                                                                                                                                                                                                                                                                                        |
      |                                           |                 |                                                          | .. note::                                                                                                                                                                                                                                                                                              |
      |                                           |                 |                                                          |                                                                                                                                                                                                                                                                                                        |
      ...
      +-------------------------------------------+-----------------+----------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | kubernetes.io/elb.class                   | Yes             | String                                                   | Select a proper load balancer type. **This parameter cannot be modified after the Service is created.**                                                                                                                                                                                                |
      |                                           |                 |                                                          |                                                                                                                                                                                                                                                                                                        |
      |                                           |                 |                                                          | Options:                                                                                                                                                                                                                                                                                               |
      |                                           |                 |                                                          |                                                                                                                                                                                                                                                                                                        |
...
#. Enter the URL in the address bar of the browser, for example, **10.78.42.242:80**. **10.78.42.242** indicates the IP address of the load balancer, and **80** indicates the access port displayed on the CCE console.

   The Nginx is accessible.


   .. figure:: /_static/images/en-us_image_0000002484118980.png
...
#. Create and edit the **nginx-elb-svc.yaml** file to configure Service parameters. **nginx-elb-svc.yaml** is an example file name. You can rename it as needed.
   ...
   .. code-block::
      ...
      metadata:
        annotations:
          ...
          kubernetes.io/elb.enterpriseID: '0'       # ID of the enterprise project that the load balancer belongs to
          kubernetes.io/elb.lb-algorithm: ROUND_ROBIN                   # Load balancer algorithm
          kubernetes.io/elb.session-affinity-mode: SOURCE_IP          # The sticky session type is source IP address.
          kubernetes.io/elb.session-affinity-option: '{"persistence_timeout": "30"}'     # Stickiness duration, which is measured in minutes
          kubernetes.io/elb.health-check-flag: 'on'                   # Enable ELB health check.
   ...
   .. table:: **Table 6** annotations parameters
      ...
      +-------------------------------------------+-----------------+---------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | kubernetes.io/elb.autocreate              | Yes             | :ref:`elb.autocreate <cce_10_0681__table939522754617>` object | Whether to automatically create a load balancer for the Service. **This parameter cannot be modified after the Service is created.**                                                                                                                                                                                                        |
      |                                           |                 |                                                               |                                                                                                                                                                                                                                                                                                                                             |
      |                                           |                 |                                                               | .. caution::                                                                                                                                                                                                                                                                                                                                |
      |                                           |                 |                                                               |                                                                                                                                                                                                                                                                                                                                             |
      |                                           |                 |                                                               |    CAUTION:                                                                                                                                                                                                                                                                                                                                 |
      ...
      +-------------------------------------------+-----------------+---------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | kubernetes.io/elb.subnet-id               | N/A             | String                                                        | ID of the subnet where the cluster is located. The value can contain 1 to 100 characters.                                                                                                                                                                                                                                                   |
      |                                           |                 |                                                               |                                                                                                                                                                                                                                                                                                                                             |
      |                                           |                 |                                                               | -  Mandatory when a cluster of v1.11.7-r0 or earlier is to be automatically created.                                                                                                                                                                                                                                                        |
      |                                           |                 |                                                               | -  Optional for clusters of a version later than v1.11.7-r0.                                                                                                                                                                                                                                                                                |
      +-------------------------------------------+-----------------+---------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | kubernetes.io/elb.enterpriseID            | No              | String                                                        | **This parameter is available in clusters of v1.15 or later. In clusters earlier than v1.15, load balancers are created in the default project by default.**                                                                                                                                                                                |
      |                                           |                 |                                                               |                                                                                                                                                                                                                                                                                                                                             |
