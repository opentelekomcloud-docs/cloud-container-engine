...
#. Configure Service parameters. In this example, only mandatory parameters required for using SNI are listed. For details about how to configure other parameters, see :ref:`Using the CCE Console <cce_10_0681__section84162025538>`.
