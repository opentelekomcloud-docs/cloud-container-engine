...
Configuring a Static IP Address for a Pod in a CCE Turbo Cluster
================================================================
...
-  Currently, only StatefulSet pods or pods without **ownerReferences** can be configured with static IP addresses. Deployments, DaemonSets, and other types of workloads cannot be configured with static IP addresses. In addition, pods with :ref:`hostNetwork <cce_10_0402>` configured cannot be configured with static IP addresses.
   ...
   If the pod name remains unchanged, CCE Turbo clusters of v1.19.16-r80, v1.21.12-r0, v1.23.11-r0, v1.25.6-r0, v1.27.3-r0, v1.28.1-r0, or later support static IP addresses for non-StatefulSet pods. For details, see :ref:`Table 1 <cce_10_0603__table9600144121919>`.
...
.. _cce_10_0603__table9600144121919:
...
.. table:: **Table 1** Annotations of the pod's static IP address
   ...
   +==========================================+=================+========================================================================================================================================================================================================================================================================================================================+========================================================================================================================================+
   | yangtse.io/static-ip                     | false           | Whether to enable a static IP address for a pod. This function is available only for StatefulSet pods or pods without **ownerReferences**. This function is disabled by default.                                                                                                                                       | **false** or **true**                                                                                                                  |
   +------------------------------------------+-----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------+
   | yangtse.io/static-ip-skip-check          | false           | Whether to skip pod type verification. If your pod **ownerReferences** is not StatefulSet and the pod name remains unchanged, you can configure this parameter to support static IP addresses for non-StatefulSet pods. If the pod name changes, the static IP address will become invalid.                            | **false** or **true**                                                                                                                  |
   |                                          |                 |                                                                                                                                                                                                                                                                                                                        |                                                                                                                                        |
   |                                          |                 | Clusters of v1.19.16-r80, v1.21.12-r0, v1.23.11-r0, v1.25.6-r0, v1.27.3-r0, v1.28.1-r0, or later support this parameter.                                                                                                                                                                                               |                                                                                                                                        |
   +------------------------------------------+-----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------+
