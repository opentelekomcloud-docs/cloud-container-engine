...
#. Choose **Settings** in the navigation pane and click the **Network** tab.
...
.. note::
   ...
   #. Run the following command to filter the pods that use the configuration in the cluster (**example** is used as an example):
