...
+-----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Supported OS                      | HCE OS 2.0 is supported.                                                                                                                                                                                                                                                                                                         |
|                                   |                                                                                                                                                                                                                                                                                                                                  |
...
+================+================+=================+============================================================================================================================+==============================================+
| 3.0.1          | Commercial use | v1.28           | -  CCE standard clusters' VPC networks are supported.                                                                      | `v1.18 <https://docs.cilium.io/en/v1.18/>`__ |
|                |                |                 | -  For new clusters with an initial version of v1.34 or later with DataPlane V2 enabled, kube-proxy does not run on nodes. |                                              |
|                |                | v1.29           | -  Cilium has been upgraded to v1.18.3.                                                                                    |                                              |
