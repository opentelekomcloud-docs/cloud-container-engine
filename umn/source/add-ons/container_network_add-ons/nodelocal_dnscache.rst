...
.. table:: **Table 3** NodeLocal DNSCache updates

   +-----------------+---------------------------+-------------------------------------------+-------------------+
   | Add-on Version  | Supported Cluster Version | New Feature                               | Community Version |
   +=================+===========================+===========================================+===================+
   | 1.7.66          | v1.28                     | Supported CCE clusters v1.34.             | 1.26.0            |
   |                 |                           |                                           |                   |
   |                 | v1.29                     |                                           |                   |
   |                 |                           |                                           |                   |
   |                 | v1.30                     |                                           |                   |
   ...
   |                 | v1.34                     |                                           |                   |
   +-----------------+---------------------------+-------------------------------------------+-------------------+
   | 1.7.2           | v1.27                     | Upgraded the community version to 1.26.0. | 1.26.0            |
   |                 |                           |                                           |                   |
   |                 | v1.28                     |                                           |                   |
   |                 |                           |                                           |                   |
   |                 | v1.29                     |                                           |                   |
   ...
   |                 | v1.33                     |                                           |                   |
   +-----------------+---------------------------+-------------------------------------------+-------------------+
   | 1.6.80          | v1.25                     | Supported CCE clusters v1.32.             | 1.22.20           |
   |                 |                           |                                           |                   |
   |                 | v1.27                     |                                           |                   |
   |                 |                           |                                           |                   |
   |                 | v1.28                     |                                           |                   |
