...
:ref:`Table 3 <cce_02_0355__table835415466262>` describes the response parameters.
...
.. table:: **Table 5** Data structure of the metadata field
   ...
   +-----------------------+-----------------------+-------------------------------------------------------------------------------------------------------------------------+
   | annotations           | Map<String,String>    | Annotations of a node pool in key-value pairs.                                                                          |
   |                       |                       |                                                                                                                         |
   |                       |                       | This parameter is used only for query and cannot be input through a request. Entered data of this parameter is invalid. |
   +-----------------------+-----------------------+-------------------------------------------------------------------------------------------------------------------------+
   | updateTimestamp       | String                | Time when a node pool was updated.                                                                                      |
   +-----------------------+-----------------------+-------------------------------------------------------------------------------------------------------------------------+
   | creationTimestamp     | String                | Time when a node pool was created.                                                                                      |
   +-----------------------+-----------------------+-------------------------------------------------------------------------------------------------------------------------+
   | resourceVersion       | Integer               | Timestamp of the last update time of a node pool.                                                                       |
   +-----------------------+-----------------------+-------------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 7** Data structure of the **nodeTemplate** field
   ...
   |                       |                                                              |    }]                                                                                                                                                                                                                                                                              |
   +-----------------------+--------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | runtime               | :ref:`Runtime <cce_02_0355__table163721555105015>` object    | Container runtime. The default value is containerd.                                                                                                                                                                                                                                |
   +-----------------------+--------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _cce_02_0355__table10946114617286:

.. table:: **Table 8** Data structure of the **login** field
...
.. table:: **Table 9** Data structure of the **Volume** field
...
.. table:: **Table 10** Data structure of the **dataVolumeMetadata** field
...
.. table:: **Table 11** Data structure of the **publicIP** field
...
.. table:: **Table 12** Data structure of the **eip** field
...
.. table:: **Table 13** Data structure of the **bandwidth** field
...
.. table:: **Table 15** Data structure of the primaryNic/extNics field
   ...
   +------------+------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | subnetList | Array of strings | Network ID list of the subnet where the ENI resides. Multiple subnets can be configured for a node pool.                                                                                              |
   +------------+------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _cce_02_0355__table153332427337:

.. table:: **Table 16** Data structure of the spec/extendParam field
   ...
   +-------------------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | kubeReservedCpu         | Integer               | Reserved node CPU cores for Kubernetes components. The unit is mcore.                                                                                                                                                                                                                                                                              |
   |                         |                       |                                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       | **Constraints**                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       |                                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       | The sum of kubeReservedCpu and systemReservedCpu is less than 50/ %of the minimum CPUs of the nodes in a node pool.                                                                                                                                                                                                                                |
   +-------------------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | systemReservedCpu       | Integer               | Reserved node CPU cores for system components. The unit is mcore.                                                                                                                                                                                                                                                                                  |
   |                         |                       |                                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       | **Constraints**                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       |                                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       | The sum of kubeReservedCpu and systemReservedCpu is less than 50/ %of the minimum CPUs of the nodes in a node pool.                                                                                                                                                                                                                                |
   +-------------------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | kubeReservedPid         | Integer               | eserved node PIDs for Kubernetes components. The purpose is to reserve a specified number of PIDs for Kubernetes daemons, such as kubelet and container runtime.                                                                                                                                                                                   |
   |                         |                       |                                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       | **Constraints**                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       |                                                                                                                                                                                                                                                                                                                                                    |
   ...
   +-------------------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | systemReservedPid       | Integer               | Reserved node PIDs for system components. The purpose is to reserve a specified number of PIDs for the OS daemons, such as sshd and udev.                                                                                                                                                                                                          |
   |                         |                       |                                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       | **Constraints**                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       |                                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       | The sum of kubeReservedPid and systemReservedPid is less than 50/ %of the maximum number of Linux PIDs.                                                                                                                                                                                                                                            |
   ...
   |                         |                       | [0,2097152] Note: CCE verifies only the scenario where kernel.pid_max is 4194304. The kernel.pid_max of nodes created on or before January 30, 2022 is different from that of some OSs. If you have updated kernel.pid_max, ensure that the sum of kubeReservedPid and systemReservedPid is less than the upper limit of the number of Linux PIDs. |
   +-------------------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | kubeReservedStorage     | Integer               | Reserved temporary storage space of a node for Kubernetes components. The unit is Gi. The purpose is to reserve temporary storage for Kubernetes daemons, such as kubelet and container runtime.                                                                                                                                                   |
   |                         |                       |                                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       | **Constraints**                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       |                                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       | The sum of kubeReservedStorage and systemReservedStorage is less than 50/ %of the disk space used by container components.                                                                                                                                                                                                                         |
   +-------------------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | systemReservedStorage   | Integer               | Reserved temporary storage space of a node for system components. The unit is Gi. The purpose is to reserve temporary storage for OS daemons, such as sshd and udev.                                                                                                                                                                               |
   |                         |                       |                                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       | **Constraints**                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       |                                                                                                                                                                                                                                                                                                                                                    |
   |                         |                       | The sum of kubeReservedStorage and systemReservedStorage is less than 50/ %of the disk space used by container components.                                                                                                                                                                                                                         |
...
.. table:: **Table 17** Data structure of the autoscaling field
...
.. table:: **Table 18** Data structure of the nodeManagement field
...
.. table:: **Table 19** Data structure of the status field
   ...
   +------------------------------+----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | creatingNode                 | Integer                                                                    | Number of nodes that are being created in the current node pool.                                                                                                                              |
   +------------------------------+----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | deletingNode                 | Integer                                                                    | Number of nodes that are being deleted in the current node pool.                                                                                                                              |
   +------------------------------+----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | activeNode                   | Integer                                                                    | Number of ready nodes in the current node pool.                                                                                                                                               |
   +------------------------------+----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | configurationSyncedNodeCount | Integer                                                                    | The number of nodes specified in the node pool configuration has been synchronized in the current node pool.                                                                                  |
   +------------------------------+----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   |                              |                                                                            | .. note::                                                                                                                                                                                     |
   |                              |                                                                            |                                                                                                                                                                                               |
   |                              |                                                                            |    The preceding node pool status has been deprecated. It is reserved only for compatibility. Do not use it anymore.                                                                          |
   +------------------------------+----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | jobId                        | String                                                                     | ID of the job to delete the node pool.                                                                                                                                                        |
   +------------------------------+----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | conditions                   | Array of :ref:`NodePoolCondition <cce_02_0355__table148153319556>` objects | Node pool status details. For details, see the definition of Condition.                                                                                                                       |
   +------------------------------+----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | scaleGroupStatuses           | Array of :ref:`ScaleGroupStatus <cce_02_0355__table122793239417>` objects  | Detailed status of a scaling group. For details, see the definition of ScaleGroupStatus.                                                                                                      |
   +------------------------------+----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 20** Runtime
   ...
   | Parameter             | Type                  | Description                                                                                                                                                                   |
   +=======================+=======================+===============================================================================================================================================================================+
   | name                  | String                | Container runtime. The default value is containerd.                                                                                                                           |
   +-----------------------+-----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | runtimeClass          | String                | Container runtime subtype.                                                                                                                                                    |
   |                       |                       |                                                                                                                                                                               |
   |                       |                       | **Constraints**                                                                                                                                                               |
   |                       |                       |                                                                                                                                                                               |
   |                       |                       | Secure runtimes are supported only for ECSs (PMs) in CCE Turbo clusters and the upper-layer runtime is containerd.                                                            |
   |                       |                       |                                                                                                                                                                               |
   |                       |                       | **Range**                                                                                                                                                                     |
   |                       |                       |                                                                                                                                                                               |
   |                       |                       | -  runc: common runtime                                                                                                                                                       |
   |                       |                       | -  kata: secure runtime. This option requires c6 or c7 series ECSs (PMs) and supports EulerOS 2.10.                                                                           |
   |                       |                       | -  kuasar-vmm: secure runtime v2. This option requires HCE OS 2.0 and clusters of v1.28.15-r70, v1.29.15-r30, v1.30.14-r30, v1.31.10-r30, v1.32.6-r30, v1.33.5-r20, or later. |
   +-----------------------+-----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. _cce_02_0355__table122793239417:

.. table:: **Table 28** ScaleGroupStatus

   +----------------------------+----------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Parameter                  | Type                                                                       | Description                                                                                                                                                                                       |
   +============================+============================================================================+===================================================================================================================================================================================================+
   | name                       | String                                                                     | Scaling group name.                                                                                                                                                                               |
   +----------------------------+----------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | uid                        | String                                                                     | Scaling group UUID.                                                                                                                                                                               |
   +----------------------------+----------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | creationTimestamp          | String                                                                     | The time when a scaling group was created.                                                                                                                                                        |
   +----------------------------+----------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | updateTimestamp            | String                                                                     | The time when a scaling group was updated.                                                                                                                                                        |
   +----------------------------+----------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | phase                      | String                                                                     | Scaling group status.                                                                                                                                                                             |
   |                            |                                                                            |                                                                                                                                                                                                   |
   |                            |                                                                            | Options:                                                                                                                                                                                          |
   |                            |                                                                            |                                                                                                                                                                                                   |
   ...
   |                            |                                                                            |    .. note::                                                                                                                                                                                      |
   |                            |                                                                            |                                                                                                                                                                                                   |
   |                            |                                                                            |       The preceding scaling group status has been deprecated. It is reserved only for compatibility. Do not use it anymore.                                                                       |
   +----------------------------+----------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | desiredNodeCount           | Integer                                                                    | Expected number of nodes in a scaling group.                                                                                                                                                      |
   +----------------------------+----------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | unpaidScaleNodeCount       | Integer                                                                    | Number of nodes in an unpaid order.                                                                                                                                                               |
   +----------------------------+----------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | activeNodeCount            | Integer                                                                    | Number of ready nodes in a scaling group.                                                                                                                                                         |
   +----------------------------+----------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | scaleDownDisabledNodeCount | Integer                                                                    | Number of nodes that cannot be deleted in a scaling group.                                                                                                                                        |
   +----------------------------+----------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | conditions                 | Array of :ref:`NodePoolCondition <cce_02_0355__table148153319556>` objects | Scaling group status details. For details, see the definition of Condition.                                                                                                                       |
   +----------------------------+----------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _cce_02_0355__table148153319556:

.. table:: **Table 29** NodePoolCondition
   ...
   |                       |                       | -  LockedByOrder: The node pool or scaling group is locked due to a pending order. The value of Reason is the ID of the order.                                                                                                                           |
   |                       |                       | -  Error: There is an error in the node pool or scaling group. The error is typically triggered by a deletion failure.                                                                                                                                   |
   +-----------------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | status                | String                | Current status of the condition.                                                                                                                                                                                                                         |
   |                       |                       |                                                                                                                                                                                                                                                          |
   |                       |                       | Range                                                                                                                                                                                                                                                    |
   |                       |                       |                                                                                                                                                                                                                                                          |
   ...
   +-----------------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | lastProbeTime         | String                | Time when the status was last checked.                                                                                                                                                                                                                   |
   +-----------------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | lastTransitTime       | String                | Time when the status was last changed.                                                                                                                                                                                                                   |
   +-----------------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | reason                | String                | Reason why the status was last changed.                                                                                                                                                                                                                  |
   +-----------------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | message               | String                | Detailed description about the condition.                                                                                                                                                                                                                |
   +-----------------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
:ref:`Table 30 <cce_02_0355__zh-cn_topic_0079614900_table46761928>` describes the status code of this API.
